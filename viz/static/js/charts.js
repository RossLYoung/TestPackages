...
function makeGraphs(error, projectsJson, statesJson) {
    ...
    //Define Dimensions
    var dateDim = xfilter.dimension(function(d) {return d["date_posted"];});
    var resourceTypeDim = xfilter.dimension(function(d) { return d["resource_type"]; });
    var povertyLevelDim = xfilter.dimension(function(d) { return d["poverty_level"]; });
    var stateDim = xfilter.dimension(function(d) { return d["school_state"]; });
    var totalDonationsDim  = xfilter.dimension(function(d) { return d["total_donations"]; });
    ...
    var totalDonations = xfilter.groupAll().reduceSum(function(d) {return d["total_donations"];});
